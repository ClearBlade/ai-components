...
const updateComponentFn = async (component: Record<string, any>, assetTypeId: string, settings: Record<string, any>) => {
...
export function useUpdateComponent({ onSuccess, onError }: { onSuccess: () => void; onError?: (error: Error) => void }) {
  return useMutation(({ component, assetTypeId, settings }: { component: Record<string, any>, assetTypeId: string, settings: Record<string, any> }) => updateComponentFn(component, assetTypeId, settings), {
    onSuccess,
    onError,
  });
}
